...
default_model_config = {
    ...
    'activation': 'tanh', 
    'Tau0': (1, 120), 
    'Tau1': np.array([1.1, 1.5 , 2.5 , 4.8 , 6. , 8., 10., 12., 16., 20]),#np.array([1.1, 4. , 4. , 4. , 9. , 9. ]), 
    'Tau2': np.array([1.2, 1.7 , 2.2 , 5. , 6.4 , 8.5,]),#np.array([1.2, 5.1, 5.1, 5.1, 8.1, 8.1]),
    'Tau3': np.array([1.3, 3.2, 3.2, 3.2, 6.2, 6.2]),
